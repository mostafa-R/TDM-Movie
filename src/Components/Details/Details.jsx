    ...
    <>
      ...
      {Object.keys(movie).length !== 0 && (
        <section className="bg-white dark:bg-gray-800">
          <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 sm:mr-auto sm:ml-auto md:mr-auto md:ml-auto mt-5  bg-black/10 rounded-2xl shadow-2xl">
